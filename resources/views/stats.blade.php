            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 space-y-8 lg:px-8">
                ...
                <h2
                    ...
                    <div class="grid md:grid-cols-2 gap-10">
                        ...
                        <div class="relative bg-white/90 rounded-2xl shadow-lg p-12">
                            <!-- Info button top-right -->
                            <a href="{{ route('stats.show', 'activity') }}"
                               class="absolute top-4 right-4 w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center shadow hover:bg-blue-700 transition">
                    ...
                    <div class="grid md:grid-cols-2 gap-10 mt-10">
                        ...
                        <div class="relative bg-white/90 rounded-2xl shadow-lg overflow-x-auto p-12">

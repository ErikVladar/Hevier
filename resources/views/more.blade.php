    ...
    <x-foreground>
        <section class="pt-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <x-bio-left name="Rastislav Pavlikovský" img="storage/imgs/amb1/"
                ...
                <x-bio-right name="Petra Vlhová" img="storage/imgs/amb2/"
                    ...
                    uspech1="Majsterka sveta v obrovskom slalome (2019)"
                    uspech2="Víťazka celkového Svetového pohára (2021)"
                    uspech3="Zlatá medaila v slalome zo Zimných olympijských hier (2022)"
                    uspech4="Viac než 30 víťazstiev a viac než 70 pódiových umiestnení vo Svetovom pohári"
                    uspech5="Ocenenie Rad Ľudovíta Štúra I. triedy za mimoriadne zásluhy o rozvoj Slovenska v oblasti športu (2024)" />

                <x-bio-left name="Marián Hossa " img="storage/imgs/amb3/"
                ...
                <x-bio-right name="Paulína Batovská Fialková" img="storage/imgs/amb4/"
                    ...
                    uspech1="9x pódiové umiestnenie v rámci Svetového pohára"
                    uspech2="4x strieborná medaila na Svetovom pohári" uspech3="5x bronzová medaila na Svetovom pohári"
                    uspech4="6. miesto v celkovom hodnotení Svetového pohára (2019)"
                    uspech5="3x účasť na Zimných olympijských hrách (2014, 2018, 2022)" />

                <x-bio-left name="Žigmund Pálffy" img="storage/imgs/amb5/"

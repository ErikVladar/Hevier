    ...
    <x-foreground>
        <section class="pt-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 class="animate__animated animate__zoomIn animate__slow text-6xl font-bold text-center mb-12 text-black">Chcem Viac</h2>
                ...
                <div class="w-full py-16 px-6" data-aos="fade-up">
                    <h2 class="text-4xl font-bold text-blue-800 mb-24 text-center">Ako ti pohyb pomáha</h2>

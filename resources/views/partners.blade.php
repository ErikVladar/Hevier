<x-app-layout>
    <x-foreground>
        <section class="md:pt-20 pb-32 py-16 px-4 text-center rounded-t-3xl">
            ...
            <h2 class="text-4xl font-bold mb-12 text-black">Generálny partner</h2>
            ...
            <h2 class="text-4xl font-bold mb-12 text-black">Hlavný partner</h2>
            ...
            <h2 class="text-4xl font-bold mb-12 text-black">Partneri</h2>
            ...
            <h2 class="text-4xl font-bold mb-12 text-black">Inštitucionálni Partneri</h2>

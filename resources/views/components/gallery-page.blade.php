    ...
    <div x-data="{ isOpen: false, activeIndex: 0 }">
        ...
        <section class="py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 class="text-6xl font-bold text-center mb-12">{{ $galleryTitle }}</h2>
                ...
                @if($images->count())
                    ...
                    <div class="relative w-full max-w-3xl mx-auto">
                        <img src="{{ $cover->path }}" alt="{{ $cover->title }}"
                             ...
                             @click="activeIndex=0; isOpen=true">

                        @if($extraCount > 0)
                            <button class="absolute top-2 right-2 bg-white/80 rounded-full p-2 shadow hover:bg-gray-200"
                                    @click="activeIndex=0; isOpen=true">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center">
                                <span class="text-white text-2xl font-semibold mb-2">{{ $galleryTitle }}</span>

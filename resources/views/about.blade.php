                        ...
                        <section>
                            <div class="space-y-16 max-w-7xl">
                                ...
                                <div class="animate__animated animate__zoomIn animate__slow space-y-6 p-8 rounded-2xl">
                                    <div x-data="{ editing: false }" class="relative w-full">
                                        <div x-show="!editing">
                                            <h2 class="text-4xl md:text-5xl font-bold text-black mb-4">
                                                {{ $content['about']['about_section_title'] ?: 'O čom je kniha' }}</h2>
                                            @auth
                                    ...
                                    <div x-data="{ editing: false }" class="relative w-full">
                                        <div x-show="!editing">
                                            <p class="text-2xl text-justify md:text-3xl text-black leading-relaxed">
                                                {{ $content['about']['about_section_body'] }}</p>
                                            @auth
                                                <button @click.prevent="editing = true"
                                                    class="absolute -top-4 -right-4 p-2 bg-white text-black rounded-full shadow hover:bg-gray-200 z-10">✏️</button>
                                            @endauth
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                                    <div class="animate__animated animate__slideInLeft animate__slow p-8 rounded-2xl">
                                        <div x-data="{ editing: false }" class="relative w-full">
                                            <div x-show="!editing">
                                                <h2 class="text-4xl md:text-5xl font-semibold text-black mb-4">Pre koho
                                                    je určená</h2>
                                                <ul
                                                    class="text-xl md:text-2xl list-disc text-justify list-inside text-black space-y-2">
                                    ...
                                    <div
                                        class="animate__animated animate__slideInRight animate__slow flex items-center justify-center">
                                ...
                                <div
                                    class="animate__animated animate__zoomIn animate__slow lg:col-span-2 space-y-2 p-8 rounded-2xl">
                                    <div x-data="{ editing: false }" class="relative w-full">
                                        <div x-show="!editing">
                                            <h2 class="text-4xl md:text-5xl font-semibold text-black mb-4">Prečo kúpiť
                                            </h2>

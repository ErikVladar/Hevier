<x-app-layout>
    ...
    <div id="toth-modal" class="fixed inset-0 hidden bg-black bg-opacity-80 z-50 flex items-center justify-center">
        <div class="relative w-full h-full flex items-center justify-center">
            ...
            <div class="w-full h-full flex items-center justify-center p-6">
                <video class="w-[90vw] h-[80vh] rounded-2xl shadow-2xl" controls preload="metadata">
                    <source src="{{ asset('storage/imgs/IMG_3675.mp4') }}" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p class="text-m md:text-2xl p-4 text-justify text-gray-800 leading-relaxed">
                                        ...
                                        chôdzu na dlhé trate, známy predovšetkým svojimi úspechmi na medzinárodných
                                        súťažiach. Počas svojej kariéry získal množstvo medailí z majstrovstiev sveta,
                                        Európy aj Olympijských hier, vrátane zlatej medaily na Olympijských hrách. Jeho
                                        disciplína, vytrvalosť a odhodlanie robia z neho vzor pre mladých športovcov,
                                        ktorí sa chcú učiť, že pravidelný tréning, obetavosť a srdce pre šport prinášajú
                                        výnimočné výsledky. Okrem športu sa venuje aj motivácii mladých ľudí a šíreniu
                                        povedomia o zdravom životnom štýle.
                                    </p>
                                </div>
                            </div>
                        </div>

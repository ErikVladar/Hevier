    ...
    var x,
        ...
        g = {
            init: function (a) {
                ...
                h(this).bind(I.start, function (a) {
                    for (var b in c.pages)
                        if (
                            p(b, c.pages) &&
                            i._eventStart.call(c.pages[b], a) === false
                        )
                            return false;
                });
                h(document)
                ...
                1 <= e[0] && e[1] <= d.totalPages
                    ? ((a = Math.floor(2)),
                      d.totalPages - e[1] > e[0]
                          ...
                          : ((c = Math.min(d.totalPages - e[1], a)),
                            (b = 2 * a - c)))
                    : (c = b = 5);
                return [
                    Math.max(1, e[0] - b),
                    Math.min(d.totalPages, e[1] + c),
                ];
            },
            ...
            disable: function (a) {
                ...
                for (b in c.pages)
                    p(b, c.pages) &&
                        c.pages[b].flip("disable", a ? h.inArray(b, d) : !1);
                return this;
            },
            size: function (a, b) {
                if (a && b) {
                    ...
                    for (e in c.pageWrap)
                        p(e, c.pageWrap) &&
                            ...
                            c.pages[e] &&
                                c.pages[e].css({ width: d, height: b }));
                    this.turn("resize");
                    return this;
                }
            ...
            previous: function () {
                ...
                return this.turn(
                    "page",
                    g._view.call(this, a.page).shift() - 1
                );
            },
        ...
        i = {
            ...
            _cAllowed: function () {
                return (
                    J[this.data().f.opts.corners] || this.data().f.opts.corners
                );
            },
                ...
                if (
                    (b =
                        ...
                        (!b ||
                            ...
                            (2 != a.opts.page &&
                                a.opts.page != b.data().totalPages - 1))) &&
                    !a.bshadow
                )
            ...
            resize: function (a) {
                ...
                a &&
                    ...
                    b.opts.frontGradient &&
                        b.ashadow.css({ width: d, height: c }),
                    i._backGradient.call(this) &&
                        b.bshadow.css({ width: c, height: d }));
                b.parent.is(":visible") &&
                    (b.fwrapper.css({
                ...
                var o = this.data().f,
                    ...
                    F = function () {
                        ...
                        if (
                            ...
                            (B = y - u / Math.sin(m)),
                            (n = j(
                                Math.round(B * Math.cos(m)),
                                Math.round(B * Math.sin(m))
                            )),
                            A && (n.x = -n.x),
                            D)
                        )
                        ...
                        z = m * Math.sin(2 * d);
                        p = j(
                            Math.round(A ? m - B : e + B),
                            Math.round(D ? z : u - z)
                        );
                        v = m * Math.sin(d);
                        m = i._c2.call(b, a.corner);
                        m = Math.sqrt(
                            Math.pow(m.x - a.x, 2) + Math.pow(m.y - a.y, 2)
                        );
                        H = m < r ? m / r : 1;
                        if (
                    ...
                    x = function (a, c, e, k) {
                        ...
                        o.fpage
                            .parent()
                            .transform(
                                t(k) + s(a.x + p.x - n.x, a.y + p.y - n.y, w),
                                e
                            );
                        o.opts.frontGradient &&
                            M(
